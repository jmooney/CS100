        ...
        <Folder name="CS100">
            <Folder name="Math">
                <Folder name="Primitives">
                    <File name="CS100\Math\Primitives\AbsolutePrimitives.py" />
                    <File name="CS100\Math\Primitives\DiscretePrimitives.py" />
                    <File name="CS100\Math\Primitives\GeometricPrimitives.py" />
                    <File name="CS100\Math\Primitives\__init__.py" />
                </Folder>
                <File name="CS100\Math\Vector.py" />
                <File name="CS100\Math\__init__.py" />
            </Folder>
            <Folder name="Physics">
                <File name="CS100\Physics\CollisionPrimitives.py" />
                <File name="CS100\Physics\CollisionWorld.py" />
